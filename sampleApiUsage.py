  ...
  messages=[
    ...
    }, 
    {
      ...
      "content": [
        {
          "type": "text",
          "text": "In this case, a user is on a 5 day streak of completing their tasks. \
              This users habits include: 'Apply to 5 jobs a day', 'Research companies for 30 minutes a day', \
                  'Spend 30 minutes a day fixing resumes, cover letters, etc.' Their long term goal is finding a job within 3 months"
        },
      ] 
    }
  ]
